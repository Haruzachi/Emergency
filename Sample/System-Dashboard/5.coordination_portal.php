...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO coordination (incident_id, agency_name, message) VALUES (?, ?, ?)");
    $stmt->bind_param("iss", $incident_id, $agency, $message); $stmt->execute(); $stmt->close();
}
?>
...
<form method="POST">
    ...
    <input name="agency_name" class="form-control mb-2" placeholder="Agency Name" required>
