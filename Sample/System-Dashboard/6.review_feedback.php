...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $rating = $_POST['rating'];
    $stmt = $conn->prepare("INSERT INTO feedback (incident_id, reviewer_name, feedback_text, rating) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("issi", $incident_id, $reviewer, $text, $rating); $stmt->execute(); $stmt->close();
}
?>
...
<form method="POST">
    ...
    <input name="reviewer_name" class="form-control mb-2" placeholder="Reviewer Name" required>
    <textarea name="feedback_text" class="form-control mb-2" placeholder="Feedback" required></textarea>
